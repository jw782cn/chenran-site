...
const plans: Plan[] = [
  ...
  {
    id: "system",
    title: "方案三：2 个月混合顾问总包",
    subtitle: "更适合总包合作，把线下和线上节奏都放进去",
    price: 88000,
    listPrice: 118000,
    bestFor: "适合 DR 希望管理层看到持续推进，而不是一周培训后自然结束",
    onsite: ["A 首周现场 AI 启动营 × 1", "B 追加线下专题辅导日 × 2"],
    online: ["C 线上课后答疑 × 4", "D 线上应用辅导课 × 4", "E 线上顾问例会 × 6"],
    included: { a: 1, b: 2, c: 4, d: 4, e: 6 },
  },
  {
    id: "custom",
    title: "自由组合",
...
const planDetails = [
  ...
  {
    title: "方案 3：2 个月混合顾问总包",
    body:
      "适合项目不止停留在首周培训，而是在 1 到 2 个月内通过线下和线上结合的方式，持续推动团队应用。",
    items: [
      "首周完成 5 个上午现场培训",
      "后续安排 4 次线上课后答疑",
      "后续安排 2 次线下专题辅导日",
      ...
      "线上顾问例会主要面向管理层和项目负责人，用于持续跟进团队应用情况、阶段问题和下一步推进建议",
    ],
  },
];
...
const summaryItems = [
  ...
  "如果希望更持续地推进，并包含后续线下专题辅导，可选择方案 3",
];
